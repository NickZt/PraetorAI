...
class RagVerticle : CoroutineVerticle() {
    ...
    override suspend fun start() {
        ...
        // LangChain4j Components - Use Ollama for embeddings
        val embeddingModel = dev.langchain4j.model.ollama.OllamaEmbeddingModel.builder()
            .baseUrl(config.getString("ollama.base-url", "http://localhost:11434"))
            .modelName(config.getString("ollama.embedding-model", "nomic-embed-text"))
        ...
        chatModel = OllamaChatModel.builder()
            .baseUrl(config.getString("ollama.base-url", "http://localhost:11434"))
            .modelName(config.getString("ollama.model", "llama3.1:8b"))
