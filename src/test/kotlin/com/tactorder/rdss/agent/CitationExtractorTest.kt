...
class CitationExtractorTest {
    ...
    fun `should extract APA style citations`() {
        val text = "Recent studies (Smith, 2023) have shown that machine learning models can be optimized for edge deployment. " +
    ...
    fun `should extract IEEE style citations`() {
        val text = "Several approaches have been proposed [1], [2, 3]. The most comprehensive study [4] suggests that " +
